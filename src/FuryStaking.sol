/**
 *Submitted for verification at cronoscan.com on 2022-07-22
*/
...
contract FuryRewards is ERC20, ERC20Burnable, Ownable {
...
contract FuryStaking is Ownable, IERC721Receiver {
  ...
  mapping(uint256 => Stake) public vault; 
   ...
   constructor(ERC721Enumerable _nft, FuryRewards _token) { 
    nft = _nft;
    token = _token;
  }
...
// rewardmath = 1000 ether .... (This gives 10 tokens per day per NFT staked to the staker)
  ...
  function _claim(address account, uint256[] calldata tokenIds, bool _unstake) internal {
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
      ...
      rewardmath = 300 ether * (block.timestamp - stakedAt) / 86400;
